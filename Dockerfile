...
RUN wget --output-document=codesys.package 'https://store-archive.codesys.com/ftp_download/3S/LinuxSL/2302000005/4.12.0.0/CODESYS%20Control%20for%20Linux%20SL%204.12.0.0.package' && \
